...
times. This section fixes the temporal-graph vocabulary, introduces the labelling problems for
temporal connectivity, and states the capacity-constrained variant we study.
...
polynomial-time $O(n^{2/3+\epsilon})$-approximation for DSF, for any fixed $\epsilon>0$; we employ this approximation algorithm for our algorithm design.

%====================================================================
\section{The Algorithm}\label{sec:algorithm}
%====================================================================

There are four ingredients in our algorithm ---backbone construction, backbone labelling, backbone routing, and
shortest-path routing---and then we combine them together (Algorithm~\ref{alg:main}).
...
We now analyze Algorithm by proving its correctness, showing that every backbone edge carries at most two labels, and establishing its approximation ratio.
...
several---the canonical route $R(u,v)$ is a temporal path. Hence there is a temporal path between every terminal pair, and all backbone flows 
