...
\end{equation}
The infrastructure term is unavoidable: any edge with positive flow dispatches a whole vehicle per
label, i.e.\ at most $2$, giving $2|\ESF|$; it is independent of $\theta$ and must not be dropped.
